...
def p7 : Prop := 
    ItsRaining → (TheStreetsAreWet → ItsRaining)
    -- parenthesis not necessary here (right assoc)
...
def p8 : Prop := 
    (ItsRaining → TheStreetsAreWet) → ItsRaining
    -- parenthesis absolutely necessary in this case
...
def p9 : Prop := 
    (ItsRaining ∧ TheStreetsAreWet) → TheStreetsAreWet
...
def p10 : Prop := 
    (TheStreetsAreWet ∧ ¬ TheStreetsAreWet) → false
