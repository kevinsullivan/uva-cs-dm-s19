...
If you are in Professor Sullivan's class, you are to complete problems 1 - 8. If you are in Prof. Hocking's class, you are to complete problems 9 - 13. 

To complete this homework, first make a copy of this file in the "work" directory of your class repository. Do not edit this file directly in the hw directory. Make a copy first. Then fill in answers as required, save your changes, and submit your work by uploading the completed file on Collab.

The first eight problems require that you carefully read the updated class notes on relations vs. functions and on properties of functions, from the start of 2.4 through 2.4.4. For all of the remaining problems, you must have read the rest of the chapter, on higher-order functions. 

Make a copy of this file in your work directory; complete the work using that copy; then upload the resulting file, after saving it, through Collab before the due date.
-/
...
/-
2. Give an example of a value in the domain of definition the function, F, as defined in the reading, that proves that F is strictly partial, i.e., for which F is not defined.
...
/-
6. Translate our logical definition of injective into mathematically precise English following the examples for other properties of functions given in the reading.
...
/-
8. Is the relation, 3x^2 + 4y^2 = 4, single-valued? Explain your answer briefly.
